...
/*void PrintGap(int hight)
{
    // prints the gap between the two half-pyramids
    for(int s = 0; s < hight / 2; s++)
    {
        printf(" ");
    }
...
{
    // on the first line prints one hash, and then one more on each line
    for(int k = 0; (k < (i + 1)); k++)
    {
        printf("#");   
    }
...
int main(void)
{
    ...
    /*
     *Building a pyramid according to the user's input
     */  
