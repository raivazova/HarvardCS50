    ...
    <form action = "buy.php" method = "post" >
        <fieldset>
           <td> <div class="form-group">
                <input class="form-control" name="symbol" value= "<?= $name ?>" placeholder="Symbol" type="text">
            </div></td>
            <td><div class="form-group">
                <input class="form-control" name="shares" value= "<?= $number ?>"placeholder="Shares" type="number" step="10">
            </div></td>
            <td><div class="form-group">
